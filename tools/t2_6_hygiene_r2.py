...
def main(argv=None):
    ...
    out["validity"] = pending_validity("hygiene_only", "T2 fixed/scaled age grids are not an approved measured-v7 certificate axis; this is a hygiene audit, not a new outcome.")
