...
def run_gate(
    ...
    for index, link in enumerate(T7.LINK_NAMES):
        command = [
            ...
            "--duration", str(duration_s), "--log-dt", str(log_dt_s),
    ...
    monitor(infra_path, duration_s, 0.1, tag="g1-static-v3-cost-gate")
    exit_codes = []
    ...
    result = {
        "schema": "dt4n.phase_g.g1_static_v3_cost_gate.v1",
        "timestamp_utc": datetime.now(timezone.utc).isoformat(),
        "duration_s": duration_s,
        "pace_tick_s": pace_tick_s,
        "ledger_tick_s": log_dt_s,
...
def main() -> int:
    ...
    parser.add_argument("--raw-dir", type=Path, default=Path("results/RAW/phase-G/g1-static-v3-cost"))
    parser.add_argument("--out", type=Path, default=Path("results/SMOKE/phase-G/g1_static_v3_cost_gate.json"))
    parser.add_argument("--duration", type=float, default=30.0)
    parser.add_argument("--pace-tick", type=float, default=0.002)
    parser.add_argument("--log-dt", type=float, default=0.002)
