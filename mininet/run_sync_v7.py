...
def parse_args():
    ...
    p.add_argument("--offered-out", default="results/SUPERSEDED/phase-20/rho_offered.csv")
    p.add_argument("--measured-out", default="results/SUPERSEDED/phase-20/rho_measured.csv")
    p.add_argument("--meta-out", default="results/SUPERSEDED/phase-20/rho_trace_meta.json")
    p.add_argument("--flow-log-dir", default="results/RAW/phase-20/flow_logs")
