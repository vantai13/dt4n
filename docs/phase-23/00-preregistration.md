...
| K-12 | 23.6 | PC23v2-2 kich hoat hai phia: `s=2.5` loai tru 0, `s=1.5` khong (Amd 23-27 muc 5.2) | [TAT DINH] | CO, 7/7 ca hai phia | CO, 7/7 ca hai phia | dat -- KHONG tinh diem |
...
Ghi chu cho `C-1`/`C-3` (Lesson 23.5[C] muc 2.1): dai duoc dat tren gia dinh 24
dai luong tuong quan MANH. Do duoc: chi cap `(bonferroni, sidak)` trong cung o
la du thua (`corr = 0.989`); giua cac SLOT tuong quan AM (`-0.204`), va tuong
quan am lam thong ke max LON HON. Hai hieu ung gan nhu triet tieu, nen `c_supt`
