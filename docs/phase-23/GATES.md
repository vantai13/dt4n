...
| G23-331 | 23.25e | ADJUDICATED | M-274 sd-ratio MISS: median core clean@0.960 = **0.6992** >0.60 (ac/ad/bc/bd=0.6773/0.5194/0.7211/0.7716). Monitor tran cung FIRE rieng: p(rho_measured>0.99)=**0.4741--0.5042** >0.10, p99 measured dong tai 1.0094 trong khi p99 offered 1.1838--1.2062. Co bang chung saturation/censoring, nhung KHONG doi ten M-274 thanh HIT |
| G23-332 | 23.25e | ADJUDICATED | D3 measured=0.3752 chi giu lam pilot budget; **D1/D2/D3 corrected = UNDECIDED**. Lap luan "SNR measured la can duoi vo dieu kien" bi bac bo vi T9 residual correlated va T11 co saturation: covariance co the lech hai dau, TX service bi nen. Khoa R1--R7 truoc 23.26; khong thi hanh D3 nhu dinh ly |
