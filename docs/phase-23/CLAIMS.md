...
| CL-14 | Lesson 23.25 la DOI CHUNG AM: generator mot-hop khong cho uoc luong path-coupling vat ly, nhung may do khong bia ra signal vuot san va conditional sensitivity cua decision error duoc chan | `G23-307`; `G23-315..343` | (1) Clean contrast=-0.0173, LOO [-0.138,+0.143], sign khong nhan dang; chi trich nhu noise floor descriptive (`G23-340`). (2) Shared endpoint confound +0.599/+0.638 va shortfall +0.902/+0.961 (`L147`). (3) T16 chi 3/12 structured pair vuot strict null; no-host excess/k=-0.0326 (`G23-342`). (4) T17 CO DIEU KIEN tren pilot SNR va T5b target-cov: median +2.09%, worst +17.06%; legacy unit-variance +3.11%/+21.97% bi L154 supersede (`G23-343`). (5) Sua r lam err level x3.38 nhung ratio delta 0.000726. (6) Khong trich magnitude SNR/D3 corrected; worst >10% nen constraints thiet ke moi chuyen Phase 24, khong bien mat. (7) Omega 23.26 la variance-share (`L163`) |
