...
| CL-14 | Tuong quan tai THEO DUONG khong tac dong len do dung quyet dinh mot cach DOC LAP: theo dai so no phong dai phuong sai margin, nen tac dong ti le voi prior tinh. Du lieu 23.25 chi hieu chuan san nhieu; chua cho uoc luong path-coupling vat ly | `G23-307` dai so; `G23-315..326` kiem toan identifiability/nugget | (1) `k` va shared-host cong tuyen (`L146`). (2) M1 scaled omega=-0.102 +/-0.118, M3=+0.039 +/-0.055; ca hai model misspec, scale-S khong la CI vat ly (`L148/L150`). (3) M3 la bo hai diem, bang chung host la shortfall +0.902/+0.961 (`L147/L151`). (4) Edge nugget lambda=0.506--0.694; core/margin invalid, nen omega raw 0.0852 khong la can tren va correction 0.1662 chi diagnostic (`L140/L152`). (5) T8 err zero-mean tai 0.369 s=0.1566--0.1758 thay dien giai T6 ~0.052 (`L149`). (6) D3 measured=0.3752 dang TREO, SNR corrected UNDECIDED; 23.26 can R1--R5. (7) `mode=poisson` van chua kiem `c_a/c_s` (`L141`) |
