...
| L107 | PILOT A069 hop le duoi S-B tren rho `{0.740,0.780,0.820}` khong tim thay rho nao co ca hai ho cung song (`err_neo >= 0.05`). Tai .740 chi h2 song; tai .780/.820 chi poisson song | `48-a069-pilot.md`; `a069_pilot.json`; `G23-270` | Stop-rule da ky kich hoat: DUNG Lesson 23.22c, khong mo luoi tinh hon sau khi xem so. `L92` KHONG go duoc bang truc rho nay va phai nam ro trong Threats to Validity. Khong chay M-210..M-214; khong tao tag `lesson-23-22c-prereg` |
